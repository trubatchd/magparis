...
HYPRE_DIR = $(HOME)/Sources/hypre-2.11.2/src/lib
...
OBJ = paris.o solids.o modules.o vofmodules.o front.o surface_tension.o lppmodules.o st_testing.o newsolver.o MGsolver.o freesurface.o boiling.o vofnonmodule.o vof_functions.o magnetic.o
...
paris.o:  paris.f90 solids.o modules.o vofmodules.o front.o surface_tension.o lppmodules.o st_testing.o newsolver.o MGsolver.o freesurface.o boiling.o magnetic.o
	$(FC) -c $(FFLAGS) $<
...
magnetic.o: magnetic.f90 modules.o
	$(FC) -c $(FFLAGS) $<
